  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-gray-600 dark:text-gray-400">Search, filter, and export all platform users.</p>
      </div>
      ...
      <Card>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 text-left text-gray-500 dark:border-navy-700 dark:text-gray-400">
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="border-b border-gray-100 dark:border-navy-700">
                  ...
                  <td className="py-4 pr-4 text-gray-600 dark:text-gray-300">{user.email}</td>
                  ...
                  <td className="py-4 pr-4 font-medium text-gray-900 dark:text-white">{user.days_remaining ?? 0}</td>
                  <td className="py-4 pr-4 text-gray-600 dark:text-gray-300">
